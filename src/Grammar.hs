...
happyExpList = Happy_Data_Array.listArray (0,58) ([9424,32,512,61440,4,0,13312,26633,18,222,16384,32915,294,589,1178,2356,128,9424,0,0,2,32772,9,19,4096,53327,36,316,0
	])
