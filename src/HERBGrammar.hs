...
happyExpList = Happy_Data_Array.listArray (0,56) ([0,8,512,24576,0,0,0,32768,51201,256,8192,3072,32784,112,0,0,0,16,0,4096,0,8256,0,8,0,192,1,32,4108,768,49156,256,16432,0,0,0,0,0,0,1056,28800,0,66,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","Exp","Existential","Variables","LExp","E","'.'","'^'","T","F","'('","')'","'='","'<C'","'>C'","'|\\-'","','","var","pred","%eof"]
        bit_start = st * 22
        bit_end = (st + 1) * 22
...
action_9 (10) = happyShift action_20
action_9 (15) = happyShift action_21
action_9 (16) = happyShift action_22
...
happyReduction_9 (_ `HappyStk`
	(HappyAbsSyn6  happy_var_3) `HappyStk`
	_ `HappyStk`
	(HappyTerminal (TokenPredicate _ happy_var_1)) `HappyStk`
	happyRest)
	 = HappyAbsSyn7
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenPredicate _ happy_dollar_dollar -> cont 21;
	_ -> happyError' ((tk:tks), [])
	}
